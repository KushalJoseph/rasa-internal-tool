...
def create_game():
    ...
    # -Rename-
    if uploaded_file.filename != 'nlu.yml':
        abort(404,description="Please upload a file named \"nlu.yml\"")
    ...
    val = subprocess.check_call("./create_folder.sh '%s'" % game,shell=True)
    uploaded_file.save(f"./data/{game}/{uploaded_file.filename}")
